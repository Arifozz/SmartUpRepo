...
namespace PaySelf.PS4500.RifeKeyboard
{
	...
	public class Keyboard : ContentControl
	{
        ...
        public static readonly DependencyProperty KeyboardwithEntegratedNumPadStyleProperty =
			DependencyProperty.RegisterAttached("KeyboardwithEntegratedNumPadStyle", typeof(Style), typeof(Keyboard));
        /// <summary>
        /// ///////////////////////KeyboardStyleThemeProperty eklendi 
        /// </summary>
        public static readonly DependencyProperty KeyboardStyleThemeProperty =
			DependencyProperty.Register(nameof(KeyboardStyleTheme), typeof(KeyboardStyleTheme), typeof(Keyboard));
        #endregion
        ...
        public Style KeyboardwithEntegratedNumPadStyle
        {
            get { return (Style)GetValue(KeyboardwithEntegratedNumPadStyleProperty); }
            set { SetValue(KeyboardwithEntegratedNumPadStyleProperty, value); }
        }
        #endregion
		...
		private void SetKeyboardStyle()
		{
			...
			switch (KeyboardState)
			{
				...
				case KeyboardState.Numeric:
					style = NumericStyle;
					break;
				case KeyboardState.KeyboardWithEntegratedNumPad:
					style = KeyboardwithEntegratedNumPadStyle;
					break;
